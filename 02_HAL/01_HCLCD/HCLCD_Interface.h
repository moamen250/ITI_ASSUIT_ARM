...
/***********************************************************************************************************************************************/
/*##############################################################################################*/
/* @Description  :   First : LCD  has 16 pins
/*                                             - VSS : Ground
...
/*                                            - After power on wait as a maximum 40 milliseconds : this delay was handled  in initialization API
/*                                            - Any single character  which the user want to print take as a maximum 2 milliseconds
/*                                            - Any String which the user want to print take as a maximum ( 2 * number of characters ) milliseconds
 /*                               Fourth : Can use this site " https://maxpromer.github.io/LCD-Character-Creator/ " to create any special character
/*##############################################################################################*/
/*@Features  :                                                                                    */
/*                  - HCLCD_errInit()                                                                        */
